...
# instance fields
.field private mBatterySaver:Lcom/android/server/BatterySaver;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v2, p0, Lcom/android/server/AlarmManagerService;->map:Ljava/util/Map;
    ...
    iput-object v2, p0, Lcom/android/server/AlarmManagerService;->mRtcPoweroffAlarms:Ljava/util/ArrayList;
    ...
    .line 190
    invoke-virtual {p0, v1}, Lcom/android/server/AlarmManagerService;->setTimeZone(Ljava/lang/String;)V

    .line 193
    :cond_0
    new-instance v2, Lcom/android/server/BatterySaver;

    invoke-direct {v2, p0}, Lcom/android/server/BatterySaver;-><init>(Lcom/android/server/AlarmManagerService;)V

    iput-object v2, p0, Lcom/android/server/AlarmManagerService;->mBatterySaver:Lcom/android/server/BatterySaver;
    ...
    iput-object v2, p0, Lcom/android/server/AlarmManagerService;->pm:Landroid/os/PowerManager;

    .line 196
    iget-object v2, p0, Lcom/android/server/AlarmManagerService;->pm:Landroid/os/PowerManager;
    ...
    invoke-static {p1, v5, v2, v5, v3}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
    ...
    invoke-static {p1, v5, v0, v2, v3}, Landroid/app/PendingIntent;->getBroadcastAsUser(Landroid/content/Context;ILandroid/content/Intent;ILandroid/os/UserHandle;)Landroid/app/PendingIntent;
...
.method private intervalChange(Ljava/util/ArrayList;)V
    .locals 9
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    :cond_1
    iget-object v5, p0, Lcom/android/server/AlarmManagerService;->pm:Landroid/os/PowerManager;
    ...
    iget-wide v5, v0, Lcom/android/server/AlarmManagerService$Alarm;->intervalAlternative:J
    ...
    invoke-direct {p0, p1, v5}, Lcom/android/server/AlarmManagerService;->removeLocked(Ljava/util/ArrayList;Landroid/app/PendingIntent;)V

    iget-wide v3, v0, Lcom/android/server/AlarmManagerService$Alarm;->intervalAlternative:J

    .local v3, tmplong:J
    iget-wide v5, v0, Lcom/android/server/AlarmManagerService$Alarm;->repeatInterval:J

    iput-wide v5, v0, Lcom/android/server/AlarmManagerService$Alarm;->intervalAlternative:J
    ...
    invoke-direct {p0, v5, v6, v7}, Lcom/android/server/AlarmManagerService;->setAlarmWhen(IJ)J
    ...
    const-string v7, "Screen change jiangmin interval: "
    ...
    iget-wide v7, v0, Lcom/android/server/AlarmManagerService$Alarm;->intervalAlternative:J
...
.method private setAlarmWhen(IJ)J
    .locals 2
    .parameter "type"
    .parameter "Interval"
...
.method public intervalChange()V
    .locals 2
    ...
    invoke-direct {p0, v0}, Lcom/android/server/AlarmManagerService;->intervalChange(Ljava/util/ArrayList;)V
...
.method public setRepeating(IJJLandroid/app/PendingIntent;)V
    ...
    .local v10, needSync:I
    const/4 v1, 0x1

    if-ne v10, v1, :cond_1

    iget-object v1, p0, Lcom/android/server/AlarmManagerService;->mBatterySaver:Lcom/android/server/BatterySaver;
    ...
    invoke-virtual/range {v1 .. v7}, Lcom/android/server/BatterySaver;->setRepeating(IJJLandroid/app/PendingIntent;)V
    ...
    iput-wide p4, v8, Lcom/android/server/AlarmManagerService$Alarm;->repeatInterval:J
    ...
    :cond_2
    invoke-static {p0, v8, v9}, Lcom/android/server/AlarmManagerService$BaiduInjector;->setLockAgain(Lcom/android/server/AlarmManagerService;Lcom/android/server/AlarmManagerService$Alarm;I)V
    monitor-exit v2
...
.method private removeLocked(Ljava/util/ArrayList;Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    .locals 8
    .parameter
    .parameter "alarm2"
    .parameter "screenon"
    ...
    invoke-virtual {v4, v5}, Landroid/app/PendingIntent;->equals(Ljava/lang/Object;)Z
    ...
    const-string v6, " jiangmin removed alarming : pkg="
    ...
    :cond_4
    iget-wide v4, p2, Lcom/android/server/AlarmManagerService$Alarm;->when:J
    ...
    const-string v6, " jiangmin want removed alarming: pkg="
...
# virtual methods
.method public addAlarming(Lcom/android/server/AlarmManagerService$Alarm;)V
    .locals 4
    .parameter "alarm"
    ...
    invoke-virtual {p0, p1, v1}, Lcom/android/server/AlarmManagerService;->removeLocked_Alarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    ...
    :cond_0
    invoke-direct {p0, p1}, Lcom/android/server/AlarmManagerService;->addAlarmLocked(Lcom/android/server/AlarmManagerService$Alarm;)I
...
.method public removeLocked_Alarm(Lcom/android/server/AlarmManagerService$Alarm;Z)Z
    .locals 2
    .parameter "alarm"
    .parameter "screenon"
    ...
    invoke-direct {p0, v1}, Lcom/android/server/AlarmManagerService;->getAlarmList(I)Ljava/util/ArrayList;

    move-result-object v0

    .local v0, alarmList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/server/AlarmManagerService$Alarm;>;"
    invoke-direct {p0, v0, p1, p2}, Lcom/android/server/AlarmManagerService;->removeLocked(Ljava/util/ArrayList;Lcom/android/server/AlarmManagerService$Alarm;Z)Z
