...
.field private static final MUSIC_SHUTDOWN_FILE:Ljava/lang/String; = "/system/media/shutdown.mp3"
...
.method private static getShutdownMusicFilePath()Ljava/lang/String;
    ...
    const-string v4, "/system/media/shutdown.mp3"
...
.method public run()V
    ...
    .line 435
    new-instance v23, Lcom/android/server/power/ShutdownThread$4;
    ...
    .line 474
    .local v21, mVibrator:Landroid/os/Vibrator;
    if-eqz v21, :cond_8
    ...
    .line 482
    .end local v21           #mVibrator:Landroid/os/Vibrator;
    :cond_8
    :goto_6
    sget-boolean v2, Lcom/android/server/power/ShutdownThread;->mReboot:Z
    ...
    .line 477
    .end local v12           #delay:J
    .restart local v21       #mVibrator:Landroid/os/Vibrator;
    :catch_4
    move-exception v14
