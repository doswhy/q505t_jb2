...
.method protected onDisplaySafeVolumeWarning(I)V
    ...
    .line 866
    :cond_0
    sget-object v6, Landroid/view/VolumePanel;->sConfirmSafeVolumeLock:Ljava/lang/Object;
    ...
    const v7, #android:string@safe_media_volume_warning#t
    ...
    new-instance v8, Landroid/view/VolumePanel$5;

    invoke-direct {v8, p0}, Landroid/view/VolumePanel$5;-><init>(Landroid/view/VolumePanel;)V
    ...
    const v7, #android:attr@alertDialogIcon#t
    ...
    sput-object v5, Landroid/view/VolumePanel;->sConfirmSafeVolumeDialog:Landroid/app/AlertDialog;
    ...
    invoke-direct {v2, v5, v7, p0}, Landroid/view/VolumePanel$WarningDialogReceiver;-><init>(Landroid/content/Context;Landroid/app/Dialog;Landroid/view/VolumePanel;)V

    .line 884
    .local v2, warning:Landroid/view/VolumePanel$WarningDialogReceiver;
    sget-object v5, Landroid/view/VolumePanel;->sConfirmSafeVolumeDialog:Landroid/app/AlertDialog;

    invoke-virtual {v5, v2}, Landroid/app/AlertDialog;->setOnDismissListener(Landroid/content/DialogInterface$OnDismissListener;)V
    ...
    .line 889
    .local v4, windowdialog:Landroid/view/Window;
    invoke-virtual {v4}, Landroid/view/Window;->getAttributes()Landroid/view/WindowManager$LayoutParams;

    move-result-object v1

    .line 891
    .local v1, lpdialog:Landroid/view/WindowManager$LayoutParams;
    sget-object v5, Landroid/view/VolumePanel;->sConfirmSafeVolumeDialog:Landroid/app/AlertDialog;
    ...
    .end local v1           #lpdialog:Landroid/view/WindowManager$LayoutParams;
    .end local v3           #window:Landroid/view/Window;
    .end local v4           #windowdialog:Landroid/view/Window;
    :cond_2
    sget-object v5, Landroid/view/VolumePanel;->sConfirmSafeVolumeDialog:Landroid/app/AlertDialog;
    ...
    .line 901
    .end local v2           #warning:Landroid/view/VolumePanel$WarningDialogReceiver;
    :cond_3
    invoke-direct {p0}, Landroid/view/VolumePanel;->resetTimeout()V
